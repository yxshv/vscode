...
export default function Navbar() {
  return (
    <motion.nav
      ...
      initial="hidden"
      animate="visible"
      className="text-md relative flex items-center justify-between px-6 py-6 lg:px-40 lg:py-8"
    >
      <a
        href="/"
      ...
      <div className="hidden items-center justify-center gap-3 text-text-2 lg:flex">
      ...
      <div
        id="menu-content"
        className="absolute left-0 top-full flex hidden w-screen flex-col gap-2 overflow-hidden border-b border-accent-1 px-6 pb-5 text-text-2 lg:hidden"
        data-open="false"
      >
        <a className="cursor-pointer hover:text-text-1">Docs</a>
        <a className="cursor-pointer hover:text-text-1">Blog</a>
